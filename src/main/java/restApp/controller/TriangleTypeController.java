...
public class TriangleTypeController {
    ...
    public String sendTriangleType(@RequestParam(name = "a",required = true) int a, @RequestParam(name = "b",required = true) int b, @RequestParam(name = "c",required = true) int c){
